...
png("MASCARA_heatmap.png", res = 150, height = 960, width = 960)
grid::grid.newpage()
...
png("rice_s_l.png", width = 960, height = 480)
(s + l)
dev.off()
```
...
png("within_between_example_2.png", res = 150, height = 960, width = 960)
(within + between)/(within_r + between_r) + plot_layout(guides = "collect",tag_level = 'new') + plot_annotation(tag_levels = c('A','1')) #+ plot_layout(heights = unit(c(5), c("cm")), widths = c(5))
dev.off()
